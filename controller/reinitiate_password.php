<?php
    ...
    $req = fetch_user($user_id);
    $take_action = false;

    while ($donnees = $req->fetch()){
        if($donnees['id'] == $user_id){
            $bool = password_verify($code, $donnees['code']);
    ...
    if($take_action == true && $error_pwd == 0){
                    ...
                    <td>
                        ...
                        <td>
                            ...
                            <table role='presentation' border='0' cellspacing='0' cellpadding='0'>
                                ...
                                <p> Si vous n'êtes pas à l'origine de cette action, nous vous conseillons de sécuriser votre compte en réinitialisant votre mot de passe.</p>
                                ...
                                <table style='background-color:#f2f2f2;margin-top:-45px;'>
                                    ...
                                    <td style='padding-left: 23px;padding-bottom: 20px;'>
                                        <a href='http://zwa.2nd-itinet.fr/controller/forgotten.php' target='_blank' class='article'><h3 class='underline'>Demande de réinitialisation</a>
                                    </td>
                                    </th>
                                </table>
                                </div>
        ...
        $headers = 'From: "ZWatcher - Alerte de sécurité"<noreply@zwatcher.com>' . "\r\n" .
    ...
    }else if($take_action == true && $error_pwd == 1){
        $errors = "Le mot de passe est trop court";
        require('../view/insert_new.php');        
    }else if($take_action == false){
        $errors = "Le code renseigné est incorrect ou a expiré";
        require('../view/insert_new.php');
    }
