    ...
    <html>
        ...
        <h1><b>Mon parc</b></h1>
                ...
                <!--      <span class="w3-margin-right">Filter:</span> -->
                    ...
                    <a href="?action=delete_liste"><button class="w3-button w3-black"><i class="fas fa-minus w3-margin-right"></i>Suppression</button></a>
                ...
                while($donnees = $req->fetch()){
                    ...
                    echo "<div class='w3-third w3-container w3-margin-bottom'>
                        ...
                        <form action='?action=erase_liste' method = 'POST'>
