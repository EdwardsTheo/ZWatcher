...
<html>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
                ...
                <!--      <span class="w3-margin-right">Filter:</span> -->
                    ...
                    <a href="?action=delete_contact"><button class="w3-button w3-black w3-hide-small"><i class="fas fa-user-minus w3-margin-right"></i>Supprimer</button></a>
                ...
                <h4 id="contact"><b>Supprimer un contact :</b></h4>
                Saisissez le pseudo du contact que vous souhaitez supprimer.
