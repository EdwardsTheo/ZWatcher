...
<html>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
                ...
                <!--      <span class="w3-margin-right">Filter:</span> -->
                    ...
                    <a href="?action=par_contacts"><button class="w3-button w3-black w3-hide-small"><i class="fas fa-tools w3-margin-right"></i>Paramètres</button></a>
                    </div>
                    </div>
                    </div>
                </header>
                ...
                <h4 id="contact"><b>Modifier un contact :</b></h4>
                Saisissez le pseudo du contact que vous souhaitez modifier, et précisez sa nouvelle qualité.
                ...
                <hr class="w3-opacity">
                <form action="../controller/update_contact.php" method = "POST">
